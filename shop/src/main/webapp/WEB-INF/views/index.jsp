	...
	<%@ include file="layout/header.jsp" %>
				...
				<div class="carousel-inner">
					<div class="carousel-item active" data-bs-interval="10000">
						<a href="https://www.nike.com/kr/ko_kr/">
							<img src="https://tpc.googlesyndication.com/simgad/8006856824244634350?sqp=4sqPyQQ7QjkqNxABHQAAtEIgASgBMAk4A0DwkwlYAWBfcAKAAQGIAQGdAQAAgD-oAQGwAYCt4gS4AV_FAS2ynT4&rs=AOga4qlju3mWf_cUUHB_Z5CC5mHxo_HNOQ"
								class="d-block" alt="...">
						</a>
					</div>
					<div class="carousel-item" data-bs-interval="2000">
						<a
							...
							<img src="https://tpc.googlesyndication.com/daca_images/simgad/15696822161214466348"
								class="d-block" alt="...">
						</a>
					</div>
					<div class="carousel-item">
						<a
							href="https://whoisnerdy.com/?utm_source=google&utm_medium=sa_pc&utm_campaign=nerdy_sa&gclid=EAIaIQobChMIrePIydmT-QIVPsIWBR146gzcEAAYASAAEgJJ8PD_BwE">
							<img src="https://tpc.googlesyndication.com/daca_images/simgad/13356705103795557830"
								class="d-block" alt="...">
						</a>
					</div>
				</div>
		...
		<div class="mainWrap">
			<div class="cardWrap cardWrapLeft">
				<input id="pageSize" type="hidden" value="${communityBoardList.pageable.pageSize}"> <input
