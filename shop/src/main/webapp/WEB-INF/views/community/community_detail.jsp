...
<%@ include file="../layout/header.jsp" %>
	...
	<div class="commu-detail-btn-container" style="position: absolute;">
          	...
          	<c:forEach var="reply" items="${communityBoard.replies}">
          		<div id="commu-reply-${reply.id}">
		            ...
		            <div id="commu-detail-reply-content-box-${reply.user.id}">
		            	<textarea id="commu-detail-reply-origin-content-${reply.user.id}" class="commu-detail-reply-content commu-detail-reply-text" readonly>${reply.content}</textarea>
		            </div>
          		</div>
          	</c:forEach>
