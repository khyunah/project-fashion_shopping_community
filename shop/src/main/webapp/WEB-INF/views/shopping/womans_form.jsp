...
<div>
	<div>
		<div class="card" style="width: 100%; margin-bottom: 20px;">
			...
			<h4
				style="margin-left: 20px; margin-top: 250px; position: absolute; font-family: 'Black Han Sans', sans-serif;">2022
				SUMMER EVENT</h4>
		</div>
							...
							<div class="col-3 mb-5">
								<div class="card h-100">
									...
									<div class="card-body p-4">
										<div
											style="float: left; font-family: 'Black Han Sans', sans-serif;">${item.name}</div>
										<br />
	...
	<div style="">
		<ul class="pagination justify-content-center">
			...
			<li class="page-item ${pageable.first ? isDisabled : isNotDisabled}">
				<a class="page-link"
				href="/shop/search/?q=${searchTitle}&page=${pageable.number - 1}">Previous</a>
			</li>
			...
			<li class="page-item ${pageable.last ? isDisabled : isNotDisabled}">
				...
				href="/shop/search/?q=${searchTitle}&page=${pageable.number + 1}">Next</a>
			</li>
		</ul>
	</div>
	<br />
