      ...
      <table style="table-layout: fixed; width: 100%">
        ...
        <c:forEach var="Basket" items="${Baskets}">
          <tr id="tr">
            ...
            <td><button class="btn btn-dark" id="btn-basket-delete" type="submit"
                onclick="basketItemDelete(${Basket.id},${principal.user.id})"
                style="border-radius: 15px; background-color: #453675;">취소</button></td>
          </tr>
        </c:forEach>
      </table>
    </div>
    <div class="right">
      <button class="btn btn-dark" type="submit" style="width: 250px; border-radius: 20px; background-color: #453675;">
